CREATE TABLE IF NOT EXISTS linketinder_bd.candidato (
...
CREATE TABLE IF NOT EXISTS linketinder_bd.empresa (
...
CREATE TABLE IF NOT EXISTS linketinder_bd.vagas (
  idvagas SERIAL PRIMARY KEY,
  empresa_idempresa INT NOT NULL,
  FOREIGN KEY (empresa_idempresa) REFERENCES linketinder_bd.empresa(idempresa) ON DELETE NO ACTION ON UPDATE NO ACTION
);
CREATE TABLE IF NOT EXISTS linketinder_bd.competencias (
  nome_competencias SERIAL PRIMARY KEY
);
CREATE TABLE IF NOT EXISTS linketinder_bd.candidato_has_competencias (
  ...
  FOREIGN KEY (candidato_idcandidato) REFERENCES linketinder_bd.candidato(idcandidato) ON DELETE NO ACTION ON UPDATE NO ACTION,
  FOREIGN KEY (competencias_nome_competencias) REFERENCES linketinder_bd.competencias(nome_competencias) ON DELETE NO ACTION ON UPDATE NO ACTION
);
CREATE TABLE IF NOT EXISTS linketinder_bd.competencias_has_vagas (
  competencias_nome_competencias INT NOT NULL,
  vagas_idvagas INT NOT NULL,
  PRIMARY KEY (competencias_nome_competencias, vagas_idvagas),
  FOREIGN KEY (competencias_nome_competencias) REFERENCES linketinder_bd.competencias(nome_competencias) ON DELETE NO ACTION ON UPDATE NO ACTION,
  FOREIGN KEY (vagas_idvagas) REFERENCES linketinder_bd.vagas(idvagas) ON DELETE NO ACTION ON UPDATE NO ACTION
);
CREATE TABLE IF NOT EXISTS linketinder_bd.candidato_curte (
  candidato_idcandidato INT NOT NULL,
  vagas_idvagas INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS linketinder_bd.empresa_curte (
  empresa_idempresa INT NOT NULL,
  candidato_idcandidato INT NOT NULL,
